...
//                       cubit.sendLostPersonData(HelpLostPersonDataParameters(image: cubit.lostPersonImage!, lng: lng!, lat: lat!, name: na, maxEdge: null, minEdge: null));
//                     }else{

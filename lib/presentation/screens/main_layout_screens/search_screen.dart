            ...
            BlocConsumer<LostPeopleCubit, LostPeopleState>(
              listener: (context, state) {
                if(state is GetPickedImageSuccessState){
                  showDialog(context: context, builder: (context)=>const SearchImageAlertDialog());
                }
              },
              builder: (context, state) {
                ...
                return SearchTextField(
                  onCameraClicked: () {
                    cubit.selectImage(context,cubit.selectImage(context, cubit.searchLostPersonImage));
                  },
                );
              },
            ),
